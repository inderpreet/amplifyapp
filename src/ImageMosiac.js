      ...
      <div className="row row-two">
        <div className="col-8">
          <div className="row g-1 mt-0">
            <div className="col">
              <div className="img1">{props.imagePreview}</div>
            </div>
            <div className="col">
              <div className="img2">{props.imagePreview1}</div>
            </div>
          </div>
          <div className="row">
            <div className="col">
              <div className="img3">{props.imagePreview2}</div>
            </div>
          </div>
        </div>
        <div className="col align-items-center g-0">
          ...
          <div className="row g-1">
            <div className="col">
              <div className="img4">{props.imagePreview3}</div>
            </div>
          </div>
        </div>
      </div>
